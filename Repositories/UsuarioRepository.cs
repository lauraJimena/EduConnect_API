...
namespace EduConnect_API.Repositories
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public UsuarioRepository(DbContextUtility dbContextUtility)
        {
            _dbContextUtility = dbContextUtility ?? throw new ArgumentNullException(nameof(dbContextUtility));
        }
        public async Task<int> RegistrarUsuario(UsuarioDto usuario)
        {
            const string sql = @"
        ...
        public async Task<IEnumerable<UsuarioDto>> ObtenerUsuarios()
        {
            ...
            const string sql = @"SELECT id_usu, nom_usu, apel_usu, correo_usu, tel_usu
